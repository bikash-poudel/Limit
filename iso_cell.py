...
class iso_cell(object):
    ...
    def __init__(self,
        ...
        #                  LSI_storages.Point)), "The surface center of a cell must be an instance of LSI_Storages.Point"
        assert (isinstance(atmosphere,
                           iso_storages.iso_atmosphere)), "Instance of iso_storages.iso_atmosphere"
    ...
    def update_liquid_fluxes(self, liquid_fluxes):
        ...
        try:
            ...
            if len(liquid_fluxes[:-1]) == len(self.connections_l_adv):
                ...
                for ql, c_l_adv in zip(liquid_fluxes, self.connections_l_adv):
    ...
    def update_vapor_fluxes(self, vapor_fluxes):
        ...
        try:
            ...
            if len(vapor_fluxes[:-1]) == len(self.connections_v_adv):
                ...
                for qv, c_v_adv in zip(vapor_fluxes, self.connections_v_adv):
                    c_v_adv.q_v = qv
            else:
    ...
    def update_transpiration(self, q_trans=[]):
        ...
        try:
            ...
            if len(q_trans) == len(self.connections_transpiration):
                ...
                for qtrans, c_trans in zip(q_trans, self.connections_transpiration):
    ...
    def update_precipitation(self, q_prec=0.0, c_prec={"2H": 1.0, "18O": 1.0}):
        ...
        try:
            ...
            self.connection_prec.q_prec = q_prec
            self.connection_prec.c_prec = c_prec
    ...
    def update_runoff(self, q_runoff=0.0):
        ...
        try:
            ...
            self.connection_runoff.q_runoff = self.__q_runoff
