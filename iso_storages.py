...
class flux_node(object):
    ...
    def get_p_sat(self):
        ...
        p_sat = 610.59999465942383 * exp(
            17.270000457763672 * (self.T - 273.16000366210938) /
            ((self.T - 273.16000366210938) + 237.30000305175781))  # Saturation vapour pressure, ps, in pascal
...
class iso_storage(flux_node):
    ...
    def __init__(self,
        ...
        self.center = (upper_boundary + lower_boundary) / 2
    ...
    def get_storage_i(self, Isotopologue, delta_cv=0.0, deltaS_liq=0.0, **kwargs):
        ...
        """
        return self.get_liquid_volume() * self.get_conc_iso_liquid(Isotopologue=Isotopologue) \
    ...
    def get_eff_liquid_volume(self, Isotopologue, **kwargs):
        ...
        """
        return self.eff_saturation(Isotopologue=Isotopologue, **kwargs) * self.get_liquid_volume()
