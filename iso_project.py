...
class iso_project(object):
    ...
    def new_cell(self, atmosphere, area, x=0, y=0, z=0):
        """
        ...
        i_cell = iso_cell.iso_cell(location=0.0, atmosphere=atmosphere, area=area)
    ...
    def run(self, Isotopologue, delta_time, delta_cv=[], deltaS_liq=[], **kwargs):
        ...
        for i_storage in storages:
            ...
            left_c_diff_fluxes_to_left, left_c_diff_fluxes_to_right, left_c_adv_fluxes_to_left, left_c_adv_fluxes_to_right = 0, 0, 0, 0
            right_c_diff_fluxes_to_left, right_c_diff_fluxes_to_right, right_c_adv_fluxes_to_left, right_c_adv_fluxes_to_right = 0, 0, 0, 0
            ...
            matrix_B[storage_index] = i_storage_volume / delta_time + right_fluxes_i - left_fluxes_i + boundary_fluxes_i
